...
class LockDB(DatabaseProcessingUtility):
    ...
    def __init__(self,path,imageType='DepthPng'):
    ...
    def feedTemplates(self):
        ...
        for subject in self.getDirecotiresInPath(self.databasePath):
            ...
            for d in directories:
                ...
                euTemp = LockTemplate(os.path.join(self.databasePath,subject,d),subject)
                if self.imageType == 'DepthPng':
                    euTemp.loadMarks()
